...
Operational analytics project on Zomato-style rider delivery performance, built using Excel and Power BI.
behind-the-delivery-zomato-operations/
📂 Download Dataset (Excel)
👉 https://drive.google.com/drive/folders/1R8aR6bx9XsujSE-ygAmaRVFJ8Oyka7Wj?usp=drive_link (raw + cleaned dataset)
# Behind the Delivery: An Operational Analytics Study of Zomato’s Last-Mile Rider Performance
